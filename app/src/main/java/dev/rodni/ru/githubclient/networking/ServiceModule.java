...
import dev.rodni.ru.githubclient.model.AdapterFactory;
import dev.rodni.ru.githubclient.model.ZonedDateTimeAdapter;
import okhttp3.Call;
...
public abstract class ServiceModule {
    ...
    static Retrofit provideRetrofit(Moshi moshi, Call.Factory callFactory, @Named("base_url") String baseUrl) {
        return new Retrofit.Builder()
                ...
                .baseUrl(baseUrl)
                .build();
                //.addCallAdapterFactory(Rx.create())RxJava2CallAdapterFactory
    }
}
